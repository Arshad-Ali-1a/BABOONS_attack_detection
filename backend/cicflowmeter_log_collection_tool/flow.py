...
class Flow:
    ...
    def get_data(self) -> dict:
        ...
        data = {
            ...
            # Flags statistics
            # "fwd_psh_flags": flag_count.has_flag("PSH", PacketDirection.FORWARD), #removed as not needed
            # "bwd_psh_flags": flag_count.has_flag("PSH", PacketDirection.REVERSE), #removed as all zeros in dataset
            # "fwd_urg_flags": flag_count.has_flag("URG", PacketDirection.FORWARD), #removed as not needed
            # "bwd_urg_flags": flag_count.has_flag("URG", PacketDirection.REVERSE), #removed as all zeros in dataset
            "fin_flag_cnt": flag_count.has_flag("FIN"),
            # "syn_flag_cnt": flag_count.has_flag("SYN"), #removed as not needed
            # "rst_flag_cnt": flag_count.has_flag("RST"), #removed as not needed
            "psh_flag_cnt": flag_count.has_flag("PSH"),
            "ack_flag_cnt": flag_count.has_flag("ACK"),
            # "urg_flag_cnt": flag_count.has_flag("URG"), #removed as not needed
            # "ece_flag_cnt": flag_count.has_flag("ECE"), #removed as not needed
            # Response Time
            ...
            # removed below as all zeros in dataset
            ...
            # removed above as all zeros in dataset
        }
